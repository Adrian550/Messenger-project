...
""));
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 150, 212));
...
"font: 8pt;"));
        ...
        scrollAreaWidgetContents_4->setGeometry(QRect(0, 0, 388, 182));
...
"color: white;"));
        ...
        scrollAreaWidgetContents_6->setGeometry(QRect(0, 0, 388, 182));
...
"color: white;"));
        ...
        scrollAreaWidgetContents_7->setGeometry(QRect(0, 0, 388, 182));
        ...
        input_frame_box->setMinimumSize(QSize(250, 30));
        input_frame_box->setMaximumSize(QSize(250, 30));
...
"border-radius: 5px;"));
        ...
        input->setMinimumSize(QSize(250, 20));
        input->setMaximumSize(QSize(250, 20));
...
"}"));
        ...
        chat_windows->setCurrentIndex(2);
    ...
    void retranslateUi(QMainWindow *WindowClass)
    {
        ...
        signup_username->setText(QCoreApplication::translate("WindowClass", "satana", nullptr));
        label_4->setText(QCoreApplication::translate("WindowClass", "Password:", nullptr));
        signup_password->setText(QCoreApplication::translate("WindowClass", "mogila", nullptr));
        label_5->setText(QCoreApplication::translate("WindowClass", "Confirm password:", nullptr));
        signup_confirm->setText(QCoreApplication::translate("WindowClass", "kladbishehuila", nullptr));
